        ...
        try {
            ...
            container('kubectl') {
                stage('Deploy To K8S') {
                    ...
                    sh "helm ls -q | grep $deployment || helm install ./k8s/eolas -f $varsFile -n $deployment --namespace=public"
                    sh "helm upgrade $deployment ./k8s/eolas -f $varsFile --set image.repository=$image --namespace=public"
